...
function AnalysisLunch() {
  ...
  function downloadCsv() {
    ...
    downloadLink.download = "analysis.csv";
                    ...
                    <tbody>
                      {nutrition.map((nutri) => (
                        <tr>
                          ...
                          <td>{nutri.totalFat}</td>
                          <td>{nutri.totalCarb}</td>
                          <td>{nutri.totalProtein}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="padding-sections">
                <div className="fourth-section">
                  <p className="intake-h-txt">
                    YOUR TOTAL CALORIE INTAKE IS {totalIntake} CAL
                  </p>{" "}
                </div>
              </div>
            </div>
